        ...
        <Select value={value} onValueChange={setValue}>
          ...
          <SelectContent>
            <SelectGroup className="w-fit">
              ...
              <SelectItem value="send_no_rank">
                Отправка без ранжирования
              </SelectItem>
              <SelectItem value="send_and_rank">
                Ранжирование и отправка
              </SelectItem>
              <SelectItem value="rank">Ранжирование</SelectItem>
              <SelectItem value="send_ranked">
                Отправка ранжрованых данных
              </SelectItem>
            </SelectGroup>
          </SelectContent>
        </Select>
        <motion.button whileTap={{ scale: 0.9 }} className="group flex h-full max-w-fit flex-1 items-center justify-center rounded-xl border p-2 overflow-hidden">
