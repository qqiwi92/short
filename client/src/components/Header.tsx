...
export default function Header() {
  ...
  return (
    <div className="bg-opacity-radial-gradient fixed left-1/2 top-2 z-[100] w-fit -translate-x-1/2 rounded-xl px-4 backdrop-blur-xl">
      <motion.h1
        style={{ fontSize: textSizeRem, paddingTop: textSizeLinear, paddingBottom: textSizeLinear.get()-1 }}
        className="z-[100] font-bold leading-tight select-none" draggable={false}
      >
        shorter!
      </motion.h1>
    </div>
